...
public static class StudentOnBoardingAbpEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StudentOnBoardingAbpModuleExtensionConfigurator CLASS (in the Domain.Shared project)
